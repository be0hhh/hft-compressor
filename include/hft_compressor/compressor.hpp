...
HFT_COMPRESSOR_API CompressionResult compressFile(const CompressionRequest& request) noexcept;
HFT_COMPRESSOR_API Status decodeBuffer(std::span<const std::uint8_t> compressedFile,
