...
constexpr std::array<PipelineDescriptor, 47> kPipelines{{
    ...
    {"hftmac.trades_grouped_delta_qtydict_v1", "HFT-MAC trades grouped delta qtydict v1", "trades", "grouped_delta_qtydict", "gcd_scaled_timestamp_price_groups_bitflags_pgc1_qtydict", "none", "replay", "c++", PipelineAvailability::Available, "", "trades-grouped-delta-qtydict-v1", ".cxcef", "hftmac,math_v1,gcd_scale,bitpacked_flags,price_group_count_one,encoded_binary,encoded_json,record_batches,streaming_decode,file_streaming,replay_ready,ranked_when_verified"},
    {"hftmac.bookticker_delta_mask_v1", "HFT-MAC bookticker delta mask v1", "bookticker", "delta_mask", "base_state_bid_spread_change_mask_zigzag", "none", "replay", "c++", PipelineAvailability::Available, "", "bookticker-delta-mask", ".cxcef", "hftmac,math_v1,delta_mask,bid_spread,change_mask,bitpacked_flags,encoded_binary,encoded_json,record_batches,streaming_decode,file_streaming,replay_ready,ranked_when_verified"},
    ...
    {"hftmac.depth_ladder_offset_v1", "HFT-MAC depth ladder offset v1", "depth", "ladder_offset", "stateful_book_best_offset_delete_hotqty", "none", "replay", "c++", PipelineAvailability::Available, "", "depth-ladder-offset", ".cxcef", "hftmac,math_v1,ladder_offset,stateful_book,delete_bits,hot_qty,encoded_binary,encoded_json,record_batches,streaming_decode,file_streaming,replay_ready,ranked_when_verified"},
    {"hftmac.depth_ladder_offset_v2", "HFT-MAC depth ladder offset v2", "depth", "ladder_offset", "side_runs_first_offset_gaps_delete_hotqty", "none", "replay", "c++", PipelineAvailability::Available, "", "depth-ladder-offset-v2", ".cxcef", "hftmac,math_v2,ladder_offset,side_runs,first_offset_gaps,stateful_book,delete_bits,side_hot_qty,encoded_binary,encoded_json,record_batches,streaming_decode,file_streaming,replay_ready,ranked_when_verified"},
    ...
    {"trade.hftmac_varint_v1", "HFT-MAC trade varint v1", "trades", "hftmac_trade", "hftmac_varint", "none", "live", "c++", PipelineAvailability::NotImplemented, "hftmac_varint backend source is not present", "hftmac-varint", ".hfc", "hftmac,planned"},
    {"bookticker.hftmac_varint_v1", "HFT-MAC bookticker varint v1", "bookticker", "hftmac_bookticker", "hftmac_varint", "none", "live", "c++", PipelineAvailability::NotImplemented, "hftmac_varint backend source is not present", "hftmac-varint", ".hfc", "hftmac,planned"},
    {"depth.hftmac_varint_v1", "HFT-MAC depth varint v1", "depth", "hftmac_depth", "hftmac_varint", "none", "live", "c++", PipelineAvailability::NotImplemented, "hftmac_varint backend source is not present", "hftmac-varint", ".hfc", "hftmac,planned"},
    {"trade.hftmac_raw_binary_v1", "HFT-MAC trade raw binary v1", "trades", "hftmac_trade", "hftmac_raw_binary", "none", "research", "c++", PipelineAvailability::NotImplemented, "hftmac_raw_binary backend source is not present", "hftmac-raw-binary", ".hfc", "hftmac,planned"},
    {"bookticker.hftmac_raw_binary_v1", "HFT-MAC bookticker raw binary v1", "bookticker", "hftmac_bookticker", "hftmac_raw_binary", "none", "research", "c++", PipelineAvailability::NotImplemented, "hftmac_raw_binary backend source is not present", "hftmac-raw-binary", ".hfc", "hftmac,planned"},
    {"depth.hftmac_raw_binary_v1", "HFT-MAC depth raw binary v1", "depth", "hftmac_depth", "hftmac_raw_binary", "none", "research", "c++", PipelineAvailability::NotImplemented, "hftmac_raw_binary backend source is not present", "hftmac-raw-binary", ".hfc", "hftmac,planned"},
